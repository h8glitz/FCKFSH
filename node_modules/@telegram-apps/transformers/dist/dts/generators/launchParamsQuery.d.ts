export declare const launchParamsQuery: import('../camel-casing/createQueryCamelCaseGen.js').CamelCaseQueryTransformer<import('valibot').LooseObjectSchema<{
    ...
    tgWebAppData: import('valibot').OptionalSchema<import('../camel-casing/createQueryCamelCaseGen.js').CamelCaseQueryTransformerPipe<import('valibot').LooseObjectSchema<{
